...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(to right,#cb2d3e,#ef473a); height: 70px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item" id="request">
        <a class="nav-link" href="message.php">View request</a>
      </li>
    </ul>
  </div>
