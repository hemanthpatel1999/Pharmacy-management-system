  ...
  <body>
    ...
    <?php
      if(isset($_POST['update'])) {
        ...
        $sql1 = "update user set name='$name', email='$email', phone='$phone', address='$address' where username='$username';";
      ...
      if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) {
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="itemname" name="username" value="<?php echo $row['username']; ?>">
              </div>
            <div class="form-group">
              <label>Email</label>
