...
<html lang="en">
  ...
  <body>
    ...
    ?> <br>
    <a href="index.php" class="btn btn-dark" style="float: left;  margin-left: 20px;">Get Back</a> &nbsp;
    ...
    <br>
      <?php $i = 1; ?>
        ...
        <?php
          $sql = "select * from items where category='Baby Care';";
            ...
            <div class="row" style="display: inline-flex; margin-left: 25px;"> 
              <div class="card mb-3" style="width: 400px;  margin-left: 20px;">
                <div class="row no-gutters">
                  <div class="col-md-4">
                    <img src="../images/baby/<?php echo $row['img']; ?>" class="card-img" alt="img" style="margin-top: 20px;height:100px;width:100px;">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
